  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        destructive:
          'rounded-xs bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'rounded-xs border border-input bg-background hover:bg-accent hover:text-accent-foreground',
        secondary:
          'rounded-xs bg-secondary text-secondary-foreground hover:bg-secondary/80',
        ghost: 'rounded-xs hover:bg-accent hover:text-accent-foreground',
      ...
      size: {
        ...
        small: 'h-8 rounded-xs px-3',
        large: 'h-12 rounded-xs px-8',
        icon: 'h-8 w-8',
      },
      state: {
